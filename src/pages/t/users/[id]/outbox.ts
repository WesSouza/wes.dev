...
export const get: APIRoute = async function get({
  ...
  if (!page) {
    return new Response(
      JSON.stringify({
        ...
        id: 'https://wes.dev/t/users/wes/outbox',
        type: 'OrderedCollection',
        totalItems: 0,
        first: 'https://wes.dev/t/users/wes/outbox?page=1',
      }),
      {
        headers: {
  ...
  return new Response(
    JSON.stringify({
      '@context': 'https://www.w3.org/ns/activitystreams',
      id: 'https://wes.dev/t/users/wes/outbox?page=1',
      type: 'OrderedCollectionPage',
      totalItems: 0,
      partOf: 'https://wes.dev/t/users/wes/outbox',
      orderedItems: [],
    }),
    {
      headers: {
