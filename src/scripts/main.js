...
var unwex_fs = function ( bash, control ) {
	var self = this,
		...
		fs = {
			...
			'/home/wesley/projetos': { t: 'd', d: initDate, u: 'wesley wesley', m: 'drwxr-xr-x', s: 68 },
			'/home/wesley/projetos/mtv.txt': { t: 'f', d: initDate, u: 'wesley wesley', m: '-rw-r--r--', s: 734 },
			'/home/wesley/projetos/mundo-dbz.txt': { t: 'f', d: initDate, u: 'wesley wesley', m: '-rw-r--r--', s: 262 },
			'/home/wesley/projetos/mznews.txt': { t: 'f', d: initDate, u: 'wesley wesley', m: '-rw-r--r--', s: 349 },
			'/home/wesley/projetos/palavrometro.txt': { t: 'f', d: initDate, u: 'wesley wesley', m: '-rw-r--r--', s: 510 },
			'/home/wesley/projetos/prefixo9.txt': { t: 'f', d: initDate, u: 'wesley wesley', m: '-rw-r--r--', s: 389 },
			'/home/wesley/projetos/scup.txt': { t: 'f', d: initDate, u: 'wesley wesley', m: '-rw-r--r--', s: 123 },
			'/home/wesley/projetos/univision.txt': { t: 'f', d: initDate, u: 'wesley wesley', m: '-rw-r--r--', s: 536 },
			'/home/wesley/projetos/whocares.txt': { t: 'f', d: initDate, u: 'wesley wesley', m: '-rw-r--r--', s: 364 },
			'/home/wesley/oi.txt': { t: 'f', d: initDate, u: 'wesley wesley', m: '-rw-r--r--', s: 339 },
			...
			case 'cat':
				if ( !options[0] )
					...
					if ( !fs[ file ] || fs[ file ].t != 'f' ) {
						...
						$.ajax( {
							url: '/fsf/'+ file.replace( /[^a-z\d]+/g, '-' ).replace( /-+/g, '-' ).replace( /(^-|-$)/g, '' ) +'.txt',
